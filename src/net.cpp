...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("Pioneershares-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("Pioneershares-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("Pioneershares-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Pioneershares " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    	{"seed", "seed.blockpioneers.info"},
		{"seed2", "seed2.blockpioneers.info"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("Pioneershares-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("Pioneershares-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("Pioneershares-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("Pioneershares-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Pioneershares is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("Pioneershares-start");
